...
public class Square {
     ...
     */
    final float[] mSquareCoords;
    final float[] mColor;
    public Square(float[] squareCoords, float[] color)
    {
        if (squareCoords == null)
            mSquareCoords = Arrays.copyOf(Square.squareCoords, Square.squareCoords.length);
        else
            mSquareCoords = Arrays.copyOf(squareCoords, squareCoords.length);
        if (color == null)
            mColor = Arrays.copyOf(Square.color, Square.color.length);
        else
